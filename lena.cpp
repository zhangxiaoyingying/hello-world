...
void main()
{
	...
	//src=cvLoadImage("E:\\实验素材\\周杰学长\\下载地形原始数据\\美国潘迪顿机场\\Rectangle_#4_卫图_Level_19.tif");//由于是32位运行，所以，图片要放在opencvtest\opencvtest文件下
	...
	//cvReleaseImage(&src);
	Mat img=imread("E:\\实验素材\\周杰学长\\下载地形原始数据\\美国潘迪顿机场\\Rectangle_#4_卫图_Level_19.tif");
	imshow("image",img);
	waitKey(0);
